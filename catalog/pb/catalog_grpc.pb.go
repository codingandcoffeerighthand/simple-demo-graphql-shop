...
type CatalogServiceClient interface {
	...
	GetProduct(ctx context.Context, in *GetProductRequests, opts ...grpc.CallOption) (*GetProductResponses, error)
...
func (c *catalogServiceClient) GetProduct(ctx context.Context, in *GetProductRequests, opts ...grpc.CallOption) (*GetProductResponses, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetProductResponses)
...
type CatalogServiceServer interface {
	...
	GetProduct(context.Context, *GetProductRequests) (*GetProductResponses, error)
...
func (UnimplementedCatalogServiceServer) GetProduct(context.Context, *GetProductRequests) (*GetProductResponses, error) {
...
func _CatalogService_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).GetProduct(ctx, req.(*GetProductRequests))
	}
	return interceptor(ctx, in, info, handler)
}
